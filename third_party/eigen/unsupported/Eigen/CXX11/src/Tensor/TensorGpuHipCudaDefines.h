...
// intact), the
// HIP tensorflow build defines EIGEN_USE_HIP when compiling all source files,
// and
// "unsupported/Eigen/CXX11/Tensor" has been updated to use HIP header when
// EIGEN_USE_HIP is
// defined. In continuation of that requirement, the guard here needs to be
// EIGEN_USE_HIP as well
