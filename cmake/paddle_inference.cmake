...
if(WITH_CUDA AND WITH_IPU)
  message(FATAL_ERROR "Cannot build with WITH_CUDA=ON and WITH_IPU=ON on the same time.")
endif()
  ...
  if (NOT PADDLEINFERENCE_URL)
    ...
    elseif(APPLE)
      ...
      if(CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "aarch64")
        ...
        if(NEED_ABI0)
          if(WITH_CUDA OR WITH_IPU OR WITH_KUNLUNXIN)
      ...
      if(WITH_CUDA)
        ...
        if(NOT PADDLEINFERENCE_API_COMPAT_2_5_x)
          if(NOT DEFINED CMAKE_CUDA_STANDARD)
            ...
            message(WARNING "Found PADDLEINFERENCE_API_CUSTOM_OP=ON and WITH_CUDA=ON, but CMAKE_CUDA_STANDARD is not defined, use c++ 14 by default!")
          elseif(NOT (CMAKE_CUDA_STANDARD EQUAL 14))
            set(CMAKE_CUDA_STANDARD 14 PARENT_SCOPE)
            message(WARNING "Found PADDLEINFERENCE_API_CUSTOM_OP=ON and WITH_CUDA=ON, force use c++ 14!")
          endif()
        endif()
      endif()
    endif()
